  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-2">View and manage user ratings for drivers</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="text-2xl font-bold text-gray-900 mt-1">{ratings.length}</div>
        </div>
        <div className="bg-white rounded-lg shadow p-6">
          <div className="text-sm text-gray-600">Rated Drivers</div>
          <div className="text-2xl font-bold text-gray-900 mt-1">{userStats.length}</div>
        </div>
        <div className="bg-white rounded-lg shadow p-6">
