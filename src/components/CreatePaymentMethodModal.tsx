...
import type { CreatePaymentMethodData } from '../types/paymentMethod';
...
const CreatePaymentMethodModal: React.FC<CreatePaymentMethodModalProps> = ({ onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setLoading(true);
      await PaymentMethodService.createPaymentMethod(formData, user.uid);
      onSuccess();
    } catch (error) {
      console.error('Error creating payment method:', error);
      setErrors({ submit: 'Failed to create payment method' });
    } finally {
      setLoading(false);
    }
  };
